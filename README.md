...
A aplicação RocketMovies está disponível para instalá-la em sua máquina localmente. Para isso, clone o projeto, acesse a pasta, instale as dependências e inicie o servidor.

```
$ git clone https://github.com/brunocasula/rocketmovies
$ cd rocketmovies
$ npm install
$ npm run dev
```
